...
RSpec.describe User, type: :model do
  ...
  describe "#favorite_for(post)" do
    before do
      topic = Topic.create!(name: RandomData.random_sentence, description: Random.random_paragraph)
    ...
    describe "#has_comments" do
      ...
      it "returns true if the user has associated comments" do
        user.posts << build(:post, user: user)
        user.post.first.comments << build(:comment, user: user)
    ...
    describe "#has_favorites" do
      ...
      it "returns true if the use has associated favorites" do
